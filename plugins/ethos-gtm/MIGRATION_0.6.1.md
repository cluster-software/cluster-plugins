...
`find-people-at-companies` skills installed by ethos-cli are retired during the
next CLI upgrade. The manual browser flow remains available temporarily for the
